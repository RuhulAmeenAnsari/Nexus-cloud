  ...
  return (
    <>
     ...
     <div className="relative h-screen overflow-hidden">
      ...
      <video autoPlay
        muted
        loop className="absolute inset-0 w-full h-full object-cover opacity-50" src={teaserfile1}></video>
      </div>
      ...
      <div className=" mt-16 h-[50vh] flex flex-wrap justify-evenly gap-4">
        ...
        <Cloud className="w-12 h-12 text-purple-500 mb-4" />
            ...
            <p className="text-white">Play instantly from any device with our powerful cloud
                infrastructure.</p>
        </div>
        <div className="border-2 p-8 bg-gray-900/50  rounded-3xl border-gray-800 h-52 w-[25vw]">
        <Gamepad2 className="w-12 h-12 text-purple-500 mb-4" />
            <h1 className="text-white my-2 text-2xl font-bold"> Vast Library</h1>
            <p className="text-white"> Access hundreds of premium games from top publishers worldwide.</p>
        </div>
        <div className="border-2 p-8 bg-gray-900/50  rounded-3xl border-gray-800 h-52 w-[25vw]">
            <Zap className="w-12 h-12 text-purple-500 mb-4" />
            <h1 className="text-white my-2 text-2xl font-bold">Cloud Powered</h1>
            <p className="text-white">     Experience gaming with ultra-low latency and stunning graphics.</p>
        </div>
